...
pub(super) const KW_LET: &[LexerKeywordSpec<Lex>] =
    &[LexerKeywordSpec::new(GRule::KwLet.as_str(), Lex::LetKw, b"let").with_flags(flags::LET)];

pub(super) const KW_MATCH: &[LexerKeywordSpec<Lex>] =
    &[
        LexerKeywordSpec::new(GRule::KwMatch.as_str(), Lex::MatchKw, b"match")
...
pub(super) const PLAIN_V3_SWITCH: &[LexerKeywordSpec<Lex>] = &[
    ...
    LexerKeywordSpec::new(GRule::KwDefault.as_str(), Lex::DefaultKw, b"default")
        .with_flags(flags::V3),
];

pub(super) const PLAIN_V3_FINAL: &[LexerKeywordSpec<Lex>] =
    &[
        LexerKeywordSpec::new(GRule::KwFinal.as_str(), Lex::FinalKw, b"final")
            .with_flags(flags::V3),
    ];
...
pub(super) const PLAIN_V3_TYPE_NAMES: &[LexerKeywordSpec<Lex>] = &[
    ...
    LexerKeywordSpec::new(GRule::KwBoolean.as_str(), Lex::BooleanKw, b"boolean")
        .with_flags(flags::V3),
    LexerKeywordSpec::new(GRule::KwAny.as_str(), Lex::AnyKw, b"any").with_flags(flags::V3),
    LexerKeywordSpec::new(GRule::KwInteger.as_str(), Lex::IntegerKw, b"integer")
        .with_flags(flags::V3),
    ...
    LexerKeywordSpec::new(GRule::KwStringType.as_str(), Lex::StringTypeKw, b"string")
        .with_flags(flags::V3),
];

pub(super) const PLAIN_V3_JAVA_BEFORE_KW_IN: &[LexerKeywordSpec<Lex>] = &[
    LexerKeywordSpec::new(GRule::KwAbstract.as_str(), Lex::AbstractKw, b"abstract")
        .with_flags(flags::V3),
    ...
    LexerKeywordSpec::new(GRule::KwCatch.as_str(), Lex::CatchKw, b"catch")
        .with_flags(flags::V3_EXC),
    LexerKeywordSpec::new(GRule::KwChar.as_str(), Lex::CharKw, b"char").with_flags(flags::V3),
    LexerKeywordSpec::new(GRule::KwConst.as_str(), Lex::ConstKw, b"const")
        .with_flags(flags::V3_CONST),
    ...
    LexerKeywordSpec::new(GRule::KwExport.as_str(), Lex::ExportKw, b"export")
        .with_flags(flags::V3_MOD),
    LexerKeywordSpec::new(GRule::KwFinally.as_str(), Lex::FinallyKw, b"finally")
        .with_flags(flags::V3_EXC),
    ...
    LexerKeywordSpec::new(
        GRule::KwImplements.as_str(),
        Lex::ImplementsKw,
        b"implements",
    )
    .with_flags(flags::V3),
    LexerKeywordSpec::new(GRule::KwImport.as_str(), Lex::ImportKw, b"import")
        .with_flags(flags::V3_MOD),
    LexerKeywordSpec::new(GRule::KwInterface.as_str(), Lex::InterfaceKw, b"interface")
        .with_flags(flags::V3),
];
...
pub(super) const PLAIN_V3_JAVA_AFTER_KW_IN: &[LexerKeywordSpec<Lex>] = &[
    ...
    LexerKeywordSpec::new(GRule::KwPackage.as_str(), Lex::PackageKw, b"package")
        .with_flags(flags::V3_MOD),
    LexerKeywordSpec::new(GRule::KwShort.as_str(), Lex::ShortKw, b"short").with_flags(flags::V3),
    LexerKeywordSpec::new(
        GRule::KwSynchronized.as_str(),
        Lex::SynchronizedKw,
        b"synchronized",
    )
    .with_flags(flags::V3),
    LexerKeywordSpec::new(GRule::KwThrow.as_str(), Lex::ThrowKw, b"throw")
        .with_flags(flags::V3_EXC),
    LexerKeywordSpec::new(GRule::KwThrows.as_str(), Lex::ThrowsKw, b"throws").with_flags(flags::V3),
    LexerKeywordSpec::new(GRule::KwTransient.as_str(), Lex::TransientKw, b"transient")
        .with_flags(flags::V3),
    ...
    LexerKeywordSpec::new(GRule::KwVolatile.as_str(), Lex::VolatileKw, b"volatile")
        .with_flags(flags::V3),
